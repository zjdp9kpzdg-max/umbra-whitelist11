...
export const metadata: Metadata = {
  ...
  description:
    "Umbra — the darkest part of a shadow. 1,111 nocturnal wardens minting on Ethereum. Relics worn in shadow. Petition the Order.",
  icons: {
  ...
  openGraph: {
    title: "UMBRA",
    description:
      "Umbra — the darkest part of a shadow. 1,111 wardens minting on Ethereum. Relics worn in shadow.",
